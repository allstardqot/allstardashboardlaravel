...
class LeaderboardController extends Controller
{
    ...
    public function viewdetail($id){
        ...
        //     if($)
        // }
        //prr($playersData);$currentWeek = currentWeek();
        return view('users/leaderboard/index',compact('user','result','playersData','newsdata','trending','userTeam','leaderboardData','topplayers','user_id'));
    }
