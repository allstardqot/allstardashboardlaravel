            ...
            <form>
              <div class="row">
                <div class="col-lg-6 col-12">
                  <input type="Name" class="form-control bgcolorinput mt-4" id="Name" placeholder="Name" name="Name">
                  <input type="email" class="form-control bgcolorinput mt-4" id="email" placeholder="Email id " name="email">
                  <input type="button" class=" d-lg-block d-none form-control btnColor mt-4" value="SEND">
                </div>
                <div class="col-lg-6 col-12 ">
                  <textarea class="form-control bgcolorinput mt-4 w-100 order-first order-lg-last " rows="5" placeholder="Your Message" id="comment"></textarea>
                </div>
