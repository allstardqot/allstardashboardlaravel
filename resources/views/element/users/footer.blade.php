        ...
        <div class="row text-white mklatr">
            ...
            <div class="col-lg-3 mt-3 col-12 text-center">
                <ul class="d-flex list-unstyled marginl djfjdf">
                    <li class="px-3">
                        <a href="#"><img src="{{asset('public/assets/image/Facebook.svg')}}" /></a>
                    </li>
                    <li class="px-3">
                        <a href="#"><img src="{{asset('public/assets/image/Twitter.svg')}}" /> </a>
                    </li>
                    <li class="px-3">
                        <a href="#"><img src="{{asset('public/assets/image/Instagram.svg')}}" /> </a>
                    </li>
                </ul>
            </div>
        </div>
