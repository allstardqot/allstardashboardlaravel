...
@section('content')
<main>
  <div class="how-to-play-sec"  >
    <div class="how-play-in"  >
      <h3 class="mt-5" ><b>Become a Champion in 3 Simple Steps!</b></h3>
      <img src="{{asset('public/img/Group 56.png')}}">
      <p class="mt-3">Nothing beats seeing your team flourish and sharing that excitement with your mates. At Fantasy Allstars, you get exactly that. Picking a winning team and celebrating with your friends under confetti rain is as easy as 1-2-3.</p>
    </div>
