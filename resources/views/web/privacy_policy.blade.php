        ...
        <div class="col-md-12">
          <div class="content-column">
            ...
            <ul>
              ...
              <li>How we safeguard your personally identifiable information;</li>
...
<p>This Policy has been developed with the objective to promote transparency and accountability in the processing of Personal Data.</p>
            ...
            <ul>
              <li><h4>Notice and Choice Principle: </h4> We don’t disclose user’s Personal Data without the user’s consent, for any purposes other than the purposes provided herein in this Policy. </li>

              <li><h4>Security Principle:  </h4> We take practical steps/measures to protect user’s Personal Data from any loss, misuse, modification, unauthorized or accidental access or disclosure, alteration, or destruction.  </li>

              <li><h4>Retention Principle:  </h4> We do not keep the processed user information for longer than is necessary for the fulfilment of the purpose while providing the services to the user. </li>

              <li><h4>Personal Data Integrity Principle </h4> The user information provided by the user while availing the services through the Platform must be accurate, complete, not misleading and up to date. </li>

              <li><h4>Access Principle:  </h4> he user has the right to access user’s Personal Data and to rectify user Personal Data.  </li>

              <li><h4>Notice and Choice Principle: </h4> We briefly capture the purposes in this Policy for which the user’s Personal Data is collected and the user's right to request access to and to request correction of the user’s Personal Data. </li>
            </ul>

            <h4>CONSENT FOR PERFORMANCE OF CONTRACT, RECTIFICATION, LEGAL OBLIGATIONS; CONSENT WITHDRAWAL</h4>
            <p>
            ...
            <p>By applying or signing up for our services, you authorize and consent to our obtaining from, and disclosing to, third parties any information about you or processing of the Personal Data in connection with identity or account verification, fraud detection, or collection procedure, or as may otherwise be allowed or required by applicable law.</p>
            <p>You can request the access to your Personal Data retained with us and can further request for correction in the retained Personal Data. If you wish to submit the request, please contact us at admin@allstarsfan.com.</p>
            <p>You can withdraw such consent to your Personal Data. Such withdrawal will not affect the lawfulness of processing based on previously recorded consent. Such withdrawal will take effect within 30 calendar days of submission of request. If you wish to submit such a request, please contact us at admin@allstarsfan.com.</p>
            <p>The specific information we collect, the method by which we collect such Personal Data, the purposes for which we collect such Personal Data, how we share such Personal Data, and how long we retain such Personal Data is explained individually, specifically for your clear, simple and withdrawable consent below in this Policy.</p>
...
<li>Information collected by Cookies and Web beacons (defined below), including using web beacons and sending cookies to your device (for more information on this please see our Cookies Policy at www.allstarsfan.com/cookies);</li>
...
<p>Personal data may also include information we collect about your individual preferences. We may collect the personal data in course of your signing up for our services, or in course of our identity or account verification process, or in course of your use of our services</p>
<p>This policy applies to your personal data when you use our Website and interact generally with us but does not apply to third-party sites. We are not responsible for the privacy policies or content of third-party sites.
  ...
  We do not knowingly collect data from, or market to, children below the legal age as established under their relevant domestic laws. By using the services, you represent that you are at least the age of majority within your respective domestic law or that you are the parent or guardian of such a minor and consent to such minor dependent’s use of the services. If we learn that personal Information from users who are less than the age of majority has been collected, we will deactivate the account and take reasonable measures to promptly delete such data from our records.
            ...
            <h4>MODE OF COLLECTION</h4>
            <h5>Information you provide to us directly</h5>
            <p>
...
<ul>
  ...
  <li>you complete any forms requesting information from you, including on registration with us, complete any survey or provide feedback to us concerning our products or services.</li>
            ...
            <p>We also may receive and store certain Personal Data about you and your device(s) automatically when you access or use our services. This information may include:</p>
            <ul>
              <li><h4>Technical information: </h4> We collect technical information associated with your activity on our Platform and may include information related to your browser and operating system, IP address (the Internet address of your computer) unique device identifiers, and other information such as your device type.</li>

              <li><h4>Site usage information:  </h4> We collect certain information to better understand customer traffic patterns and site usage. This may include the webpage that you were visiting before accessing our Platform, the pages or features of our Platform you browsed to inform us which part of our site, app and Service you visit and how much time you spend there.</li>

              <li><h4>Site preferences and cookies: </h4>We collect certain information about your preferences to make your use of the site more productive through the use of cookies. Cookies are intended to make using the service easier by, among other things, saving your preferences for you. For details of how we use cookies for this purpose, please review our cookie policy at www.allstarsfan.com/cookies.</li>

            </ul>

            <p>While we do not use some of this information to identify you personally, we may record certain information about your use of our Websites such as which pages you visit and the time and date of your visit, and that information could potentially be used to identify you.</p>
            <p>It may be possible for us to identify you from information collected automatically from your visit(s) to our Website. If you have registered an account with us, we will be able to identify you through your user name and password when you log into our Website. Further, if you access our Website via links in an email we have sent you, we will be able to identify you.</p>


            <h5>Information collected from third-party services</h5>
            ...
            <p>We do not sell, exchange or give to any other person your Personal Data, whether public or private, for any reason whatsoever, without your consent, other than for the express purpose of providing our services to you.</p>
            <p>We collect, process, and use your Personal Data for the following purposes:</p>
            <ul>
              ...
              <li>in order to: (i) protect our rights or property, or the security or integrity of our services; (ii) enforce the terms of our Terms and Conditions or other applicable agreements or policies; (iii) verify your identity (e.g., some of the government-issued identification numbers we collect are used for this purpose); (iv) investigate, detect, and prevent fraud, security breaches, and other potentially prohibited or illegal activities; (v) comply with any applicable law, regulation, or legal process.
                We may use third-party service providers to, process and store your information in the BVI and other countries in our sole discretion with the protective measures implemented and provided under this Policy.
                </li>
            </ul>

            <h4>WE PROCESS AND USE AGGREGATED, ANONYMIZED AND DE-IDENTIFIED PERSONAL DATA</h4>
            <p>We may also create, process, collect, use and share aggregated, anonymized or de-identified Personal Data such as statistical or demographic data for any purpose which may be derived from your Personal Data. We may use your Personal Data to comply with legal or regulatory obligations. 
              ...
              <ul>
                ...
                <li>Where processing is necessary for the performance of any contract entered into where you are a party or for taking any action upon your request for concluding, amending or terminating such contract;</li>
                <li>Where processing is necessary for public interest.</li>
              </ul>
              <h4>DISCLOSURE OF YOUR PERSONAL DATA TO THIRD PARTIES</h4>
              <p>We may have to share your personal information with a selected and trusted group of third party/parties to fulfil our obligations under our contract with you, to meet government, regulatory and law enforcement requests, and to continue providing you with the services. We shall ensure any such third party is aware of our obligations under this Policy and we enter into contracts with such third parties by which they are bound by terms no less protective of any Personal Data disclosed to them, than the obligations we undertake to you under this Policy or which are imposed on us under applicable data protection laws. We do not allow our third-party service providers to use your personal information for their own purposes and only permit them to process your personal information for specified purposes and in accordance with our instructions.</p>
              <p>In case of termination of our business relationships with such third parties we shall ensure that all your Personal Data is either retrieved from such third party or is destroyed. We shall also confirm in our contracts with such third parties that the third party does not have the right to use such Personal Data for unauthorized purposes. </p>
              <p>We may share or transfer your personal Information in the specific circumstances hereinbelow: </p>
              <ul>
                ...
                <li>if the disclosure is requested by law enforcement or government agency or is required by law, or legal process, such as a subpoena, court, or another legal process with which we are required to comply, including about our obligations under applicable anti-money laundering laws; if the disclosure is required to enforce the terms of this policy or to enforce any of our terms and conditions with you;</li>
              ...
              <p>In the event of a proposed restructure or sale of our business (or part of our business) or where a company proposes to acquire or merge with us, we may disclose personal data to the buyer and their advisers without your consent subject to compliance with the applicable regulations. If we sell the business and the sale is structured as a share sale, you acknowledge that this transaction will not constitute the ‘transfer’ of personal data.</p>
              <h4>INTERNATIONAL TRANSFER OF INFORMATION</h4>
              <p>Your Personal Data is stored and transferred in compliance with the applicable legislation or regulations of every jurisdiction in which we operate.</p>
              <p>If you are based in the UK, the EU or the EEA, any storage, processing and transfer of your Personal Data outside these territories will adhere to the relevant legal requirements, particularly the GDPR, as and however applicable and/or required.</p>
              <p>If you are based in the British Virgin Islands, the storage and protection of the Personal Data will be in compliance with DPA. The protection measures for your Personal Data shall be taken in accordance with this Policy.</p>
              <p>Some of our external third-party service providers may also be based outside of the UK, EU, EEA, or BVI so their processing, storage and transfer of your Personal Data will involve the transfer to and from and storage of data outside such jurisdiction. We reiterate that by using our services you accept the terms of their individual privacy policies, cookies policies, as well as terms and conditions.</p>
              <p>Some of the international organizations and countries to which your Personal Data may be transferred do not benefit from an appropriate data protection regulatory framework. For such international organizations and countries, we shall transfer your Personal Data, only upon ensuring that a suitable degree of protection is afforded to it through the implementation of the necessary safeguards, such as an adequacy decision by the relevant authority, adequate binding corporate rules or through the inclusion of standard contractual clauses in our agreements with such organizations and countries. </p>
              <p>Without prejudice to Section 5 of this Policy, you should be aware that we transfer your Personal Data outside BVI, to the following third-party service providers (albeit, the same shall not be construed as a closed list):</p>
              <ul>
                <li>Metamask.io, available at: https://consensys.net/terms-of-use/ and https://consensys.net/privacy-policy/ </li>  
              </ul>
              <p>Allstars is a fast-growing company with various global partnerships. You should be aware that certain third-party service providers, such as payment gateways and other payment transaction processors, may be located in, or have facilities that are located in, outside BVI in a different jurisdiction than either you or us. If you wish to procure specific information about the third-party service providers with whom your Information has been shared, please contact us at admin@allstarsfan.com. Therefore, if you elect to proceed with a transaction that involves the services of a third-party service provider, then your Personal Data may become subject to the laws of the jurisdiction(s) in which that service provider or its facilities are located. For example, if you are located in the BVI and your transaction is processed by a payment gateway located outside of the BVI, then your Personal Data used in completing that transaction may be subject to disclosure under that jurisdiction’s data-specific legislation. For these providers, we recommend that you read their respective privacy policies, so you can understand the manner in which your Personal Data will be handled by these providers.</p>
              <h4>THIRD-PARTY ADVERTISING AND ANALYTICS</h4>
              <p>We may allow third-party service providers to deliver content and advertisements in connection with our services and to provide anonymous site metrics and other analytics services to promote and improve our Services. These third parties may use cookies, web beacons, and other technologies to collect Information, such as your IP address, identifiers associated with your device, other applications on your device, the browsers you use to access our services, webpages viewed, time spent on webpages, links clicked, and conversion information (e.g., transactions entered into). This information which could be your Personal Data may be used by us and third-party service providers on our behalf to analyze and track usage of our services, determine the popularity of certain content, deliver advertising and content targeted to your interests, and better understand how you use our services.</p>
              <p>The third-party service providers that we engage are bound by confidentiality obligations and applicable laws with respect to their use and collection of your Personal Data.</p>
              <p>This Policy does not apply to, and we are not responsible for, third-party cookies, web beacons, or other tracking technologies, which are covered by such third parties’ privacy policies. For more information, we encourage you to check the privacy policies of these third parties to learn about their privacy practices.</p>
              <h4>LINKS TO THIRD-PARTY WEBSITES</h4>
              <p>Our Platform or communications may contain links to other third-party websites which are not owned or operated by us and are regulated by their own privacy policies. If you click on a third-party link, you will be directed to that third party’s platform. We strongly advise you to review the privacy policy of every platform you visit. </p>
              <p>This Policy does not apply to, and we are not responsible for the privacy policies of these third-party websites regardless of whether they were accessed while using links from our Platform or communications. </p>
              ...
              <ul>
                ...
                <li>The period for which your Personal Data will be stored, or if that is not possible, the criteria used to determine that period (if you are a citizen of a European Union member state and BVI); </li>
              ...
              <h4>Right to access to Personal Data</h4>
              <p>This is your right to see what personal data is held about you by us. Particularly you have the right to request and obtain the following information:</p>
              <ul>
                ...
                <li>The existence of your right to request from us rectification or erasure of Personal Data (if you are a citizen of a European Union member state and BVI);</li>
                ...
                <p>We may refuse your demand if request is excessively repeated, is in contravention of judicial proceeding or investigations, negatively impacts our endeavors to maintain Personal Data security, or relates to the privacy of a third party.</p>
                <p>If the User is from BVI, we can refuse to provide the access to Personal Data upon the fulfillment of any of the following conditions:</p>
                <li>If the compliance with the request will be in contravention of the provisions of DPA;</li>
                <li>where another person can be identified from the access to the User’s Personal Data</li>
                <li>where we obtain written approval from the administrative authority ('Information Commissioner’) of the DPA.</li>
              </ul>
              <h4>Right to rectification</h4>
              <p>You have the right to rectify any inaccurate Personal Data about you retained with us and to complete any incomplete Personal Data about you, provided however, the requisite procedures as outlined within the DPA are adhered to.</p>
              <h4>Right to erasure</h4>
              <p>You have the right to demand erasure of your Personal Data with us if:</p>
              <ul>
                ...
                <li>your Personal Data must be erased for compliance with legal obligations (if you are a citizen of a European Union member state and BVI).</li>
                <li>We may refuse your demand if your Personal Data is processed for compliance with a legal obligation; or establishment or exercise or defense of legal claims.</li>
              </ul>
              <h4>Right to restrict processing </h4>
              <p>You have the right to restrict processing of your Personal Data if:</p>
              <ul>
              ...
              <h4>Right to stop or withdraw consent for processing  </h4>
              <p>You have the right to object to our processing of your Personal Data and stop the processing of said Personal Data in the following cases:</p>
              <ul>
                ...
                <li>where such processing is in contravention of personal data protection controls as envisaged by the PDPL and mentioned under Clause 4 (Personal data protection principles); </li>
              ...
              <h4>Right to Personal Data portability </h4>
              <p>You have the right to Personal Data portability to the extent that:</p>
              <ul>
                <li>the legal basis for our processing of your Personal Data is your consent, or is a necessity to perform a contract to which you are party;</li>
                <li>such processing is carried out by automated means.</li>
              </ul>
              <p>Yo have the right to receive your Personal Data from us in a structured, commonly used and machine- readable format. Where technically feasible, you may also request us to transmit your Personal Data directly to another entity. </p>
              <h4>Right to object to automated decision making </h4>
              <p>You have the right to object to automated decision making (if any) if it has legal or serious consequences that affect you. Such requests may refused by us if such automated processing is performed in accordance to any contract between you and Allstars, is necessary for compliance with other legislation, or you have specifically provided consent for such practices.</p>
              <h4>Right to lodge a complaint with the supervisory authority </h4>
              <p>If you are an EU, UK or EEU citizen, you have the right to lodge a complaint with the supervisory authority of the member state in which you are habitually resident, or with the supervisory authority of the member state in which you work or in which your rights under the GDPR have been infringed if you believe such infringement has taken place.</p>
              <p>If you are a citizen of BVI, you have the right to raise complaint in writing to the Information Commissioner regarding your breach of right under the DPA or you believe that such infringement has taken place.</p>
              <h4>SUBMISSION OF REQUESTS FOR EXERCISE OF RIGHTS</h4>
              <p>We aim to respond to all legitimate requests without undue delay and within 2 calendar months of receipt of any request from you. Occasionally it may take us longer than 2 calendar months, if your request is particularly complex, or if you have made duplicated or numerous requests. In this case, we will notify you of receipt of such request(s) and keep you updated as to the status of progress concerning such request(s).</p>
              <p>If you are a citizen of BVI, then your legitimate request to ‘Right to Access of Personal Data’ will be responded by us within the time period of 30 days. However, the time period could be extended by Chief Executive Officer by not more than 30 days if:</p>
              <ul>
                <li>meeting the original time limit would unreasonably interfere with our operations;</li>
                <li>consultations are required to comply with your request that cannot be reasonably be completed within the original time limit of 30 days.
                    If you wish to exercise any of the rights mentioned under Clause 16 (Your rights in relation to your Personal Data), please contact us at admin@allstarsfan.com. We may need to request specific information from you to help us confirm your identity and ensure your entitlement to such rights. This security measure is to ensure that your Personal Data is not disclosed to any person who has no right to receive it.</li>
              </ul>
              <h4>PERSONAL DATA RETENTION </h4>
              <p>We retain Personal Data on your behalf, including customer data, transactional data and other session data, linked to your account. </p>
              <p>Your Personal Data will be processed for no period longer than as required by us for the purposes it was collected for, for the purposes of using our services, and for meeting any legal, accounting, reporting, government, regulatory or law enforcement requirements. However, all Personal Data and related documents, records and files will be securely retained for a period of 90 days, as required. Such retention period shall be calculated from the date of closing of your account. </p>
              <h4>LEGAL RECOURSE TO RELEVANT AUTHORITIES</h4>
              <p>If you are based in the UK, EU or the EEA region, then you have the right to make a complaint at any time to a supervisory or regulatory authority, within the UK, or a member state in the EU or EEA where you are habitually resident, where we may be based (if applicable), or where an alleged infringement of any data protection law has taken place.</p>
              <p>If you are a citizen of BVI, you have the right to raise complaint in writing to the Information Commissioner regarding your breach of right under the DPA or you believe that such infringement of DPA has taken place.</p>
              <p>However, we would appreciate the opportunity to address your concerns before you approach any such authority. Please contact us in the first instance so that we may try to resolve your complaint swiftly and satisfactorily. Please contact us via email on admin@allstarsfan.com.</p>
              <h4>SECURITY PRECAUTIONS AND MEASURES</h4>
              ...
              <p>Our facilities are scanned on a regular basis for security holes and known vulnerabilities, to best ensure its security. Your Personal Data is contained behind secured networks and is only accessible by a limited number of individuals who have special access rights to such systems and are required to keep the information confidential.</p>
              <p>We also have mechanisms in place to access your Personal Data in case of an actual or technical failure. We also ensure testing and evaluation of our technical and organizational measures at regular intervals to gauge the effectiveness of such measures.</p>
              <h4>No guarantee</h4>
              <p>Please note that no transmission over the internet or any method of electronic storage can be guaranteed to be absolutely 100% secure, however, our best endeavors will be made to secure data and the ability to access your Personal Data. </p>
              <p>Without prejudice to our efforts on protection of your Personal Data, nothing contained in this Policy constitutes a warranty of security of the facilities, and you agree to transmit data at your own risk. </p>
              <p>Please note, that we do not guarantee that your Personal Data may not be accessed, disclosed, altered, or destroyed by breach of any of our physical, technical, or managerial safeguards. Please, always check that any website on which you are asked for financial or payment information in relation to our services is in fact legitimately owned or operated by us. The risk of impersonating hackers exists and should be taken into account when using our Platform</p>
              <p>If you do receive any suspicious communication of any kind or request, do not provide your Information and report it us by contacting our offices immediately at admin@allstarsfan.com. Please also immediately notify us at admin@allstarsfan.com if you become aware of any unauthorized access to or use of your account.</p>
              <p>Since we cannot guarantee against any loss, misuse, unauthorised acquisition, or alteration of your Personal Data, please take the necessary steps to protect your own Personal Data, including the adoption of sufficient safety measures such as your choosing of an appropriate password of sufficient length and complexity and to not reveal this password to any third parties.</p>
              <p>Furthermore, we cannot ensure and do not warrant the security or confidentiality of data transmitted to us, or sent and received from us by internet or wireless connection, including: email, phone, WhatsApp or SMS, since we have no way of protecting that information once it leaves and until it reaches us. If you have reason to believe that your Personal Data is no longer secure, please contact us admin@allstarsfan.com.</p>
              <p>We also aim to conduct all applicable security risk assessments to ensure the availability of risk mitigation controls, to better safeguard the integrity of your Personal Data. </p>
              <h4>Personal Data breaches</h4>
              <p>Should your Personal Data be breached, and the security of your rights be at risk, we shall promptly and immediately communicate to you the nature of the breach which has taken place, the likely consequences of such a breach and shall describe thoroughly the measures we have implemented to address the breach and to mitigate any and all adverse effects to you and your rights. In the unlikely event of a breach occurring, please reach out to us at admin@allstarsfan.com for further information and for further advise on how to mitigate the potential adverse effects of such a breach.</p>
              <h4>CONTACTING US </h4>
              <p>If you have any questions about our Policy as outlined above, or if you have any complaints, please contact us at admin@allstarsfan.com.</p>
              <p>If you have any queries or issues pertaining to your Personal Data or our Policy, then please do write to us at any time by emailing us via admin@allstarsfan.com.</p>
          </div>
        </div>
      </div>
    </div>
