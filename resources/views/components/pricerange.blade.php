    ...
    <?php 
      ...
      $min = isset($_COOKIE['min']) ? $_COOKIE['min'] : 0;
      $max = isset($_COOKIE['max']) ? $_COOKIE['max'] : 50;
...
?>
    ...
    <!-- <script src="https://code.jquery.com/mobile/1.4.5/jquery.mobile-1.4.5.min.js"></script> -->
      ...
      <div id="gol-slider-range"></div>
      <div class="slider-labels d-flex align-items-center justify-content-between">
        <div class=" caption">
          <strong></strong> <span id="gol-slider-range-min"></span>
        </div>
        <div class=" text-end caption">
          <strong></strong> <span id="gol-slider-range-max"></span>
        </div>
      </div>
  
        <div class="price-rander">
          <form>
            <input type="hidden" id='gol-min-value' name="gol-min-value" value="<?php echo $min?>" />
            <input type="hidden" id='gol-max-value' name="gol-max-value" value="<?php echo $max?>" />
          </form>
    ...
    <script>
      ...
      $(document).ready(function () {
        ...
        var rangeSlider = document.getElementById("gol-slider-range");
        var minValue = document.getElementById("gol-min-value").value;
        var maxValue = document.getElementById("gol-max-value").value;
        ...
        rangeSlider.noUiSlider.on("update", function (values, handle) {
          document.getElementById("gol-slider-range-min").innerHTML = values[0];
          document.getElementById("gol-slider-range-max").innerHTML = values[1]+'M';
          document.getElementById("gol-min-value").value = values[0]
          document.getElementById("gol-max-value").value = values[1]
        });
      });
        ...
        function closure(target, options) {
          ...
          function attach(events, element, callback, data) {
            ...
            var method = function (e) {
                ...
                // Ignore right or goldle clicks on start #454
                if (
