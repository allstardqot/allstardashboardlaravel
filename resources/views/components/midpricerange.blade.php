    ...
    <?php 
      ...
      $min_mid = isset($_COOKIE['min_mid']) ? $_COOKIE['min_mid'] : 0;
      $max_mid = isset($_COOKIE['max_mid']) ? $_COOKIE['max_mid'] : 50;
...
?><!-- <script src="https://code.jquery.com/jquery-1.11.3.min.js"></script> -->
   ...
   */
      ...
      <!-- <script src="https://code.jquery.com/mobile/1.4.5/jquery.mobile-1.4.5.min.js"></script> -->
        ...
        <div id="mid-slider-range"></div>
        <div class="slider-labels d-flex align-items-center justify-content-between">
          <div class=" caption">
            <strong></strong> <span id="mid-slider-range-min"></span>
          </div>
          <div class=" text-end caption">
            <strong></strong> <span id="mid-slider-range-max"></span>
          </div>
        </div>
    
          <div class="price-rander">
            <form>
              <input type="hidden" id='mid-min-value' name="mid-min-value" value="<?php echo $min_mid?>" />
              <input type="hidden" id='mid-max-value' name="mid-max-value" value="<?php echo $max_mid?>" />
            </form>
      ...
      <script>
        ...
        $(document).ready(function () {
          ...
          var rangeSlider = document.getElementById("mid-slider-range");
          var midminValue = document.getElementById("mid-min-value").value;
        var midmaxValue = document.getElementById("mid-max-value").value;
          ...
          rangeSlider.noUiSlider.on("update", function (values, handle) {
            document.getElementById("mid-slider-range-min").innerHTML = values[0];
            document.getElementById("mid-slider-range-max").innerHTML = values[1]+'M';
            document.getElementsByName("mid-min-value").value = moneyFormat.from(
              values[0]
            );
            document.getElementsByName("mid-max-value").value = moneyFormat.from(
              values[1]
            );
          });
        });
