    ...
    <?php 
      ...
      $min_for = isset($_COOKIE['min_for']) ? $_COOKIE['min_for'] : 0;
      $max_for = isset($_COOKIE['max_for']) ? $_COOKIE['max_for'] : 50;
...
?>
   ...
   */
      ...
      <!-- <script src="https://code.jquery.com/mobile/1.4.5/jquery.mobile-1.4.5.min.js"></script> -->
        ...
        <div id="for-slider-range"></div>
        <div class="slider-labels d-flex align-items-center justify-content-between">
          <div class=" caption">
            <strong></strong> <span id="for-slider-range-min"></span>
          </div>
          <div class=" text-end caption">
            <strong></strong> <span id="for-slider-range-max"></span>
          </div>
        </div>
    
          <div class="price-rander">
            <form>
              <input type="hidden" id='for-min-value' name="for-min-value" value="<?php echo $min_for?>" />
              <input type="hidden" id='for-max-value' name="for-max-value" value="<?php echo $max_for?>" />
            </form>
      ...
      <script>
        ...
        $(document).ready(function () {
          ...
          var rangeSlider = document.getElementById("for-slider-range");
          var forminValue = document.getElementById("for-min-value").value;
        var formaxValue = document.getElementById("for-max-value").value;
          ...
          rangeSlider.noUiSlider.on("update", function (values, handle) {
            document.getElementById("for-slider-range-min").innerHTML = values[0];
            document.getElementById("for-slider-range-max").innerHTML = values[1]+'M';
            document.getElementsByName("for-min-value").value = moneyFormat.from(
              values[0]
            );
            document.getElementsByName("for-max-value").value = moneyFormat.from(
              values[1]
            );
          });
        });
