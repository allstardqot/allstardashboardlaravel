    ...
    <?php 
      ...
      $min_dif = isset($_COOKIE['min_def']) ? $_COOKIE['min_def'] : 0;
      $max_dif = isset($_COOKIE['max_def']) ? $_COOKIE['max_def'] : 50;
...
?>
   ...
   */
      ...
      <!-- <script src="https://code.jquery.com/mobile/1.4.5/jquery.mobile-1.4.5.min.js"></script> -->
        ...
        <div id="def-slider-range"></div>
        <div class="slider-labels d-flex align-items-center justify-content-between">
          <div class=" caption">
            <strong></strong> <span id="def-slider-range-min"></span>
          </div>
          <div class=" text-end caption">
            <strong></strong> <span id="def-slider-range-max"></span>
          </div>
        </div>
    
          <div class="price-rander">
            <form>
              <input type="hidden" id='dif-min-value' name="dif-min-value" value="<?php echo $min_dif?>" />
              <input type="hidden" id='dif-max-value' name="dif-max-value" value="<?php echo $max_dif?>" />
            </form>
      ...
      <!-- <div data-role="header">
        ...
        <div data-role="main" class="ui-content">
          <form method="post" action="/action_page_post.php">
            ...
            <p>
              The range slider can be useful for allowing users to select a
              specific price range when browsing products.
            </p>
          </form>
        </div>
      </div> -->
      <script>
        ...
        $(document).ready(function () {
          ...
          var rangeSlider = document.getElementById("def-slider-range");
          var difminValue = document.getElementById("dif-min-value").value;
        var difmaxValue = document.getElementById("dif-max-value").value;
          ...
          rangeSlider.noUiSlider.on("update", function (values, handle) {
            document.getElementById("def-slider-range-min").innerHTML = values[0];
            document.getElementById("def-slider-range-max").innerHTML = values[1]+'M';
            document.getElementsByName("def-min-value").value = moneyFormat.from(
              values[0]
            );
            document.getElementsByName("def-max-value").value = moneyFormat.from(
              values[1]
            );
          });
        });
          ...
          function closure(target, options) {
            ...
            function attach(events, element, callback, data) {
              ...
              var method = function (e) {
                  ...
                  // Ignore right or defdle clicks on start #454
                  if (
