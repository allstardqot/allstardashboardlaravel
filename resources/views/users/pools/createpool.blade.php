        ...
        <form method="POST" action="{{ url('/insert') }}">
            ...
            <div class="row">
                <div class="col-lg-6 text-center">
                    <input type="text" id="pool_name" class="inmutsfg" name="pool_name" placeholder="Create your Pool Name" /><br />
                    <input class="inmutsfg" type="number" id="entry_fees" name="entry_fees" placeholder="Enter Entry Amount" /><br />
                    {{-- <div class="text-white">
                        <select class="hdydtsb" name="team_id">
                            <option class="jytf">Select Team</option>
                            @foreach($team as $key => $value)
                               
                                <option class="jytf" value="{{ $value->id }}">{{ $value->name }}</option>
                            @endforeach
                ...
                <div class="col-lg-6 text-center">
                    ...
                    <input class="inmutsfg" type="text" id="max_participants" name="max_participants" placeholder="Enter max participants" /><br />
