        ...
        <div class="row mt-2 sortby" id="sortbydefender">
          ...
          <div class="col-sm-4 mt-3">
            <div class="range-slider">
                ...
                <div class="value-data"><p class="o-value">$0</p> <p class="defender_range range-slider__value">${{!empty($request['type']=='defender') && !empty($request['cost_range']) ?$request['cost_range']:'50' }}</p></div>
          ...
          <div class="row mt-2 sortby" id="sortbymidfielder">
            ...
            <div class="col-sm-4 mt-3">
                <div class="range-slider">
                    ...
                    <p class="range-slider__subtitle">Cost Bar</p>
                    <div class="value-data"><p class="o-value">$0</p> <p class="midfielder_range range-slider__value">${{!empty($request['type']=='defender') && !empty($request['cost_range']) ?$request['cost_range']:'50' }}</p></div>
                    ...
                    <div class="range-slider__slider">
                        ...
                        min="0"
                        max="50"
                        value="{{!empty($request['type']=='midfielder') && !empty($request['cost_range']) ?$request['cost_range']:'50' }}"
                        class="slider"
            ...
            <div class="col-sm-4 mt-3">
                <div class="range-slider">
                    ...
                    <div class="range-slider__slider">
                        ...
                        min="0"
                        max="50"
                        value="{{!empty($request['type']=='forward') && !empty($request['cost_range']) ?$request['cost_range']:'50' }}"
                        class="slider"
